...
// TODO(krnowak): Just drop it.
// OverrideIfNone allows overriding a location and a fetcher of asc if
// there was none so far.
func (a *asc) OverrideIfNone(location string, fetcher ascFetcher) {
	if a.Fetcher == nil {
		a.Location = location
		a.Fetcher = fetcher
	}
