...
// AppImageType describes a type of an image parameter. The parameter
// can be either a hash, a URL, a path, a name or none of these. The
// last option means that the application will have to deduce the
// actual type (one of the first four).
