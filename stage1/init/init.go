...
func getArgsEnv(p *Pod, flavor string, systemdVersion string, debug bool) ([]string, []string, error) {
	args := []string{}
	env := os.Environ()
	...
	if util.IsRunningSystemd() && systemdSupportsJournalLinking(systemdVersion) {
